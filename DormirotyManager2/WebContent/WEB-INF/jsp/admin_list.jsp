...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.seiryo.po.Admin" %>
...
<c:forEach items="${ai.list}" var="ai">
        <tr>
            ...
            <td class="td-manage">
                ...
                <a title="编辑" class="updateEdit" href="findAdminById?a_id=${ai.a_id}">
...
//                 console.log(JSON.stringify(param));
    ...
    function member_del(obj,a_id,a_power){
        ...
        var power = ${sessionScope.admin.a_power};
        var id = ${sessionScope.admin.a_id};
        if(power != 1 && id != a_id){
                layer.alert("对不起，您没有权限:(");
        }
